...
//        label.text = "Some test caption from hafied for now"
        return label
    }()
    ...
    private lazy var statsView: UIView = {
        ...
        devider1.anchor(top: view.topAnchor, left: view.leftAnchor, right: view.rightAnchor, paddingLeft: 8, height: 1.0)
