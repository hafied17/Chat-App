...
class UploadTweetController: UIViewController {
    ...
    @objc func handleUploadTweet() {
        ...
        TweetService.shared.uploadTweet(caption: caption, type: config) { (error, ref) in
            if let error = error {
                print("error to upload tweet \(error.localizedDescription)")
            }
    ...
    fileprivate func uploadMentionNotification(forCaption caption: String, tweetID: String?) {
        ...
        words.forEach { word in
            ...
            UserService.shared.fetchUser(withUsername: username) { mentionUser in
                NotificationService.shared.uploadNotification(toUser: mentionUser,
                                                              type: .mention,
                                                              tweetID: tweetID)
            }
        }
    ...
    func configureUI() {
        ...
        captionTextView.placeholderLebel.text = viewModel.placeholderText
